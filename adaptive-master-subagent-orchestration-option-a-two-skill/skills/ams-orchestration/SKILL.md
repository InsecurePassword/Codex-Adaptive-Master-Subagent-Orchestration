...
If a needed managed profile is missing or malformed, continue safely with an available truthful profile or master execution and direct the operator to invoke `$ams-installer`; do not bootstrap from this runtime skill.
