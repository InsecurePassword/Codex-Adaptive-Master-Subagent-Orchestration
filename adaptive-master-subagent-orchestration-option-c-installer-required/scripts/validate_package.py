...
def check_manifest():
    ...
    assert data["name"]=="adaptive-master-subagent-orchestration-option-c-installer-required"
...
def check_skills():
    ...
    mapping={"profile-manager":"ams-profile-manager","runtime":"ams-orchestration","resume":"ams-orchestration","unified":"adaptive-master-subagent-orchestration"}
