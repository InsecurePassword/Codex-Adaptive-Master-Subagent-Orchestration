...
$ExpectedSha256 = if ($env:AMS_EXPECTED_SHA256) { $env:AMS_EXPECTED_SHA256.Trim().ToLowerInvariant() } else { "74e48106fc26a6516db3e9f6cc15e66e745d4fe71e24fdee233a6cf972fe4514" }
